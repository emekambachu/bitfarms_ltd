...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('bitfarms_logo.png') }}"/>
    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img alt="logo" src="{{ asset('bitfarms_logo.png') }}" width="100">
        ...
        <nav id="topbar">
            <ul class="navbar-nav theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('bitfarms_logo.png') }}" class="navbar-logo" alt="logo">
                    </a>
                </li>
