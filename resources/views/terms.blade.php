        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-12 about-desc">
                    ...
                    <p>To be eligible to participate in any of the services of Bitfarms Limited, clients/investors or their representatives must be eighteen (18) years of age or older, or the legal age of majority in the client's/investor's home country, state or province; be legally entitled to use our services in accordance with applicable law; currently maintain a cryptocurrency account with a Wallet; and make a deposit with Bitfarms Limited totaling no less than the stipulated account on the chosen investment product (the Initial Deposit) during the investment Period as defined herein.</p>
                    <div class="gap-15"></div>
                </div>
                ...
                <div class="col-lg-12 col-12 about-desc">
                    ...
                    <p>If there are promotions of bonuses on accounts within Bitfarms Limited, these promotions will be based on a One bonus per account per client. Also, accounts are only transferable with requests made, reviewed, and granted by the management of Bitfarms Limited.</p>
                    <div class="gap-15"></div>
                </div>
                ...
                <div class="col-lg-12 col-12 about-desc">
                    ...
                    <p>Bitfarms Limited offers its services and bonuses in good faith to its Clients actively investing within its market with exposure to economic risk. Client acknowledges that his/her subscription to the services of Bitfarms Limited is for the purposes of investment only. Client's invested fund shall be utilized in legitimate trading within the market that Bitfarms Limited offers.<br>
                        In need emergence of a new market, Client shall be notified before any form of diversification is inclined to the Client's fund. This condition also requires that the Client does not associate any abusive, exploitive or improper conduct (Exploitative Activity) while being subscribed to the Bitfarms Limited investment offered services. Exploitative Activity shall include, without limitation:<br>
                        ...
                        -- Client, whether personally or through a third-party, hedges investment position(s) for purposes of capturing credited funds on a risk-free basis, by utilizing additional trading account(s) at other institutions, whether maintained by Client or an associate thereof, or by utilizing an additional account at Bitfarms Limited held by a third-party or alias, or by any other means<br>
                        Client agrees and acknowledges that the offered services shall be granted by Bitfarms Limited only as a result of representations made by Client, including Client's representation that he/she will not undertake Exploitative Activity, as defined herein. Bitfarms Limited shall have the authority to, at its sole discretion, elect to retroactively cancel the investment terms, remove any credited bonus/promotional funds from a Client's account and retroactively cancel any investment activity conducted, should Bitfarms Limited determine the Client has undertaken Exploitative
